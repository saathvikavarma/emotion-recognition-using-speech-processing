...
def main():
    ...
    if website_menu == "Emotion Recognition":
        ...
        txt = """
            This web-application is a part of the final  project  
        ...
        with col1:
            st.info("saathvikavarma@gmail.com")
            st.info("nagalakshmi@gmail.com")
            st.info("mahitha123@gmail.com")
            st.info("bhargavi07@gmail.com")
        with col2:
